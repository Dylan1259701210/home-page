		...
		children: [
			{
				...
				children: [
								...
								children: [
									{
										...
										children: [
											{
												id: "file-mainframe-001",
												name: "cobol_extract.sas",
												type: "file",
												workflow: "Automatic",
											},
											{
												id: "file-mainframe-002",
												name: "vsam_reader.sas",
												type: "file",
												workflow: "Manual",
											},
										],
					...
					},
					{
						...
						children: [
							{
								id: "file-transform-001",
								name: "transform_logic.sas",
								type: "file",
								workflow: "Automatic",
							},
							{
								id: "file-transform-002",
								name: "data_cleansing.sas",
								type: "file",
								workflow: "Manual",
							},
						],
